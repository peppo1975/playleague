...
// Definita da Massimo, in uso solo sul nuovo codice
...
if(APP_ENV != 'prod'){
	...
	// define('FULL_ABSOLUTE_URL', 'https://stagingversion.playleaguesport.it'); // Usato solo per i cron e le chiamate intra controller (non x link)
	define('FULL_ABSOLUTE_URL', 'https://playleaguesport.it');
}
else{ // PROD
 ...
 */
	Configure::write('Security.salt', 'timmysecurity');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '00001');
