<?
	...
	class Athlete extends AppModel {
				...
				function beforeSave() {
					...
					/* Commentato in data 15/09/2016 a seguito della verifica del seguente errore: 
					un atleta precedentemente tesserato e iscritto nuovamente non era inserito ne come nuovo record ne come update del vecchio
