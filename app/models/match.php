<?
	...
	class Match extends AppModel {
				...
				var $virtualFields = array(
					...
					'DataOra_it' => "CONCAT(DATE_FORMAT(Match.Data,'%d/%m/%Y'), ' ', Match.Ora)",
					'Data2' => "Match.Data",
					'Data3' => "Match.Data",
				...
				function beforeSave() {
					...
					if(isset($this->data) && !empty($this->data) && isset($this->data['Match']['Data'])) {
						...
						*/
						...
						if($count > 0 && $this->data['Match']['Campo'] != 'null' && $this->data['Match']['Ora'] != 'null' && empty($this->data['Match']['is_tennis'])) {
