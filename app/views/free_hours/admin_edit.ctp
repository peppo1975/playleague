	<?=$html->script('/js/script_for_freehour.js', true);?>
	<?=$this->element("/backend/edit_scripts");?>

	<?=$this->Form->create('FreeHour', array('action' => 'edit','prefix' => 'admin','class' => 'formAdd','type' => 'file'));?>

	<div class="form_header">

								<h2>Modifica prenotazione: <span><?=$this->data['Campi']['Descrizione'] . ' - ' . $this->data['FreeHour']['Data_it'] . '(' . $this->data['FreeHour']['Ora']. ') - ' . $this->data['FreeHour']['Nominativo'];?></span></h2>
								<ul>
