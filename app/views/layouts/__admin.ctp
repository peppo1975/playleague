...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="IT" lang="IT">
		...
		<head>
				...
				<title>Midland Sport | <?=$title_for_layout;?></title>
		...
		<div id="container">	
			...
			<div id="header">
					<ul class="admin-navigation">
						<li class="logo"><img src="/img/logo_midland_admin.png" width="35" height="35" alt="Midland Sport Firenze" /></li>						
			...
			<div id="bottom">
				<ul class="left">
					<li>Midland Sport di Luca Mar&egrave; | via G. Pagnini 13/R 50134 Firenze</li>
				</ul>
				<ul class="right">
					<li><a href="" title="Midland Sport &copy; 2011">Midland Sport &copy; 2011</a></li>
				</ul>
				<div class="clear"></div>
			</div>
