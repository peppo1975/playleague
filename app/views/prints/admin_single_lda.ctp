...
<? $fpdf->output(APP . '/webroot/'. 'files/pdf/gestione_campionati_lda_singolo_'.Inflector::Slug($athlete['Athlete']['reverseAnagrafica']).'.pdf', 'F'); ?>
<?=json_encode(array('link' => 'files/pdf/gestione_campionati_lda_singolo_'.Inflector::Slug($athlete['Athlete']['reverseAnagrafica']).'.pdf'));?>
<?else:?>
<?$handle = fopen(APP . '/webroot/'. 'files/xls/gestione_campionati_lda_singolo_'.Inflector::Slug($athlete['Athlete']['reverseAnagrafica']).'.xls',"w+");?>
