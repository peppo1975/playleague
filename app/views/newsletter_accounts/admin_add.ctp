	...
	<?=$this->Form->create('NewsletterAccount', array('action' => 'add','prefix' => 'admin','class' => 'formAdd','type' => 'file'));?>

	<div class="form_header">

								<h2>Aggiungi nuovo account email</h2>
								<ul>
	...
	<?=$this->Form->input('username', array('label' => 'Username', 'type' => 'password'));?>
	
	<?=$this->Form->input('password', array('label' => 'Password', 'type' => 'text'));?>
