        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <aside class="sidebar">
                    ...
                    <ul class="nav nav-list narrow">
                        <li class="edit-team active" data-value="edit"><a class="edit-team-button" href="/squadres/teams_edit/<?= $squadra['Squadre']['Squadra']; ?>/1" title="Modifica">Modifica squadra</a></li>
                    </ul>
                </aside>
                <div class="clear"></div>
