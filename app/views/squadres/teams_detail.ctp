                        ...
                        <li class="">
                            ...
                            <a href="/<?= $url[$sesso]; ?>/<?= $tipo; ?>/<?= $sesso; ?>">
                                ...
                                <? elseif ($tipo == 4): ?>
                                    ...
                                    Singolo <? if ($sesso == 0): ?>maschile<? else: ?>femminile<? endif; ?>

                                <? elseif ($tipo == 5): ?>

                                    Squadre <? if ($sesso == 0): ?>maschili<? else: ?>femminili<? endif; ?>
        ...
        <div class="contents-box" id="bg-retino">
            ...
            <div class="search-team">
                ...
                <div class="input autocomplete-input">
                    <input onblur="javascript:if (this.value == '')
                                this.value = 'Ricerca la squadra...';" onclick="javascript:this.value = '';" id="ricercaSquadre" class="autoComplete" type="text" data-dest="id_squadra" data-url="/sections/getSquadreAjax/<?= $tipo; ?>/<?= $sesso; ?>" value="Ricerca la squadra...">
