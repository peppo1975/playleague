    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <h3 class="title-profile-menu"><img class="team-logo" src="<?= !empty($logo) ? $logo : ''; ?>" /> <span class="team-manage text-color-primary">Gestione squadra</span> <span><?= $squadra['Squadre']['Denominazione']; ?></span></h3>
                <div class="clear"></div>
...
<!--            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <aside class="sidebar">
                    <h4 class="heading-primary">Gestione squadra</h4>
                    <ul class="nav nav-list narrow">
