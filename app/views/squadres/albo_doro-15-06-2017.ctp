...
<script type="text/javascript">
	...
	<? elseif($nameClass=="quaternary"): //GIUSEPPE 2016-12-17 ?>
	<? include("query_database.ctp"); ?>
	<? include("ranking.ctp"); ?>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="tabs tabs-bottom tabs-center tabs-simple">
						<ul class="nav nav-tabs">
							<? $godpig = 0; ?>
							<?  foreach($maschile_femminile as $tipo_sesso)://foreach($albo as $tipo_sesso => $categorie): ?>	
