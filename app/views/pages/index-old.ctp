...
<div class="wrapper-box">
	...
	<div class="wrapper-box-contents">
		<div class="contents-box" id="bg-retino">
			<div class="content-header">
				...
				<? if(1 == 0): ?>
					<ul class="content-share">
						...
						<? $pageLink = 'http://' . $_SERVER['HTTP_HOST'] . $this->requestAction('/pages/getPageUrl/' . $data['Page']['id']);?>
						...
						<li class="twt-share"><!-- Twitter button -->
							<a href="http://twitter.com/share" class="twitter-share-button" data-url="<?=$pageLink;?>" data-count="vertical" data-lang="it">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>
			...
			<?if($data['Page']['published_it'] != '' && $data['Page']['published_it'] != '00/00/0000'):?>
				<p class="post-info">pubblicato il <?=$data['Page']['published_it'];?></p><!-- solo per le news -->
			<?endif;?>
								...
								<? foreach($data['Upload'] as $attach): ?>
									<? if(in_array($attach['ext'], $ext_doc)): ?>
										...
										<div class="attached-document">
											<a href="<?=$attach['path'];?>" title="<?=$title;?>">
					...
					<? if(count($data['Block'])): ?>
						<div class="blocks">
							...
							<? foreach($data['Block'] as $block): ?>
								<? if ($data['Page']['id'] != 56): ?>
									<div class="block-box">
										<? if($block['Block']['type'] == 0): //Mostra tutto?>
										...
										<? else: ?>
											...
											<?if($block['Block']['published_it'] != '' && $block['Block']['published_it'] != '00/00/0000' && $data['Page']['id'] != 80):?>
												<p class="post-info">pubblicato il <?=$block['Block']['published_it'];?></p><!-- solo per le news -->
											<?endif;?>
											
											<div class="block-preview<? if($block['Block']['img_evidenza'] != ''): ?> with-preview<?endif;?>">
												<?=$this->Text->truncate(
													strip_tags($block['Block']['content']),
													210,
													array(
														'ending' => ' ...',
														'exact' => false
											...
											<? if($block['Block']['img_evidenza'] != ''): ?>
												<div class="block-preview-img gruppo" id="123123123" style="clear: both;">
													...
													$link  = $thumbnail->link(array('path' => $block['Block']['img_evidenza'], 'w' => 212,'h' => 90, 'zc' => 0));
								...
								<? else: ?>
									<div class="block-box" style="clear: both;">
										<? if($block['Block']['type'] == 0): //Mostra tutto?>
											<ul class="block-attachment gruppo" style="float: left;" id="<?=$block['Block']['id'];?>">
												<? foreach($block['Upload'] as $attach): ?>
													<? if(in_array($attach['ext'], $ext_img) && $attach['tag'] == 'link'): ?>
														<li style="width: auto;">
															<?
