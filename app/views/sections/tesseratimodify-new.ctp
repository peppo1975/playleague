                                        ...
                                        <div class="panel-body ats">
                                            ...
                                            <form class="form-horizontal form-bordered" autocomplete="off" method="post" onsubmit="return false;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input id="CodiceFiscale" name="<?= $i ?>" class="form-control" value="<?= $tesserato['CodiceFiscale'] ?>">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input id="Cap" name="<?= $i ?>" class="form-control" value="<?= $tesserato['Cap'] ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input id="Provincia" name="<?= $i ?>" class="form-control" value="<?= $tesserato['Provincia'] ?>">
