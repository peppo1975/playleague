...
$fields = [
	...
	"Data di nascita"   => ["readonly" => "readonly", 'dateFormat' => 'DMY', 'maxYear' => date("Y") - 18, 'minYear' => 1945, 'monthNames' => false, 'separator' => ''],
];
$names = [
	"Nazione" => "nazione",
	"Nome" => "nome",
					...
					<script type="text/javascript">
						...
						$(function(){
							...
							$('.delete-avatar').click(function(){
								...
								$.get('/users/delete_avatar/' + $(this).attr('data-athlete') + '/User', function(){
					...
					<div class="row">
						<div class="avatar-img col-md-2">
							<span class="img-thumbnail">
								<?=$thumbnail->show(array('path' => $this->data['User']['avatar'], 'w' => 50, 'h' => 50, 'zc' => 1));?>
							</span>
						</div>
						<div class="avatar-manage col-md-6">
							<a href="javascript:;" data-athlete="<?=$this->data['User']['id'];?>" class="delete-avatar" title="elimina avatar di <?=$this->data['User']['Cognome'];?> <?=$this->data['User']['Nome'];?>">
