...
<div role="main" class="main">
	...
	<div class="container" id="main-custom">
		...
		<script src="https://maps.google.com/maps/api/js?key=AIzaSyCOaIwsBzFbjvX6PqfjhcKcjCW8t8kW_Gk" type="text/javascript"></script>
				...
				<div class="contents-box" id="bg-retino">
					...
					<div class="tabs">
						<ul class="nav nav-tabs">
							...
							<li <? if($data['Campi']['countHour'] == 0): ?>class="active"<?endif;?>>
								<a href="#tornei" data-toggle="tab">Tornei</a>
							</li>

							<? if($data['Campi']['latitudine'] != '' && $data['Campi']['longitudine'] != ''): ?>	
							
							<li>
								<a href="#recent" data-toggle="tab" >Mappa</a>
							</li>
						...
						<div class="tab-content">
							...
							<div id="tornei" class="tab-pane <? if($data['Campi']['countHour'] == 0): ?>active<?endif;?>">
								<?=$this->element('/site/impianti/tornei', ['campoId' => $data['Campi']['Campo'], 'tornei' => $data['Campionati']]);?>
