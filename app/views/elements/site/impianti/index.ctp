<? //GIUSEPPE  2016/12/13 -> filtra la classe
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="contents-block-left">
                            ...
                            <div class="form-groups">
                                ...
                                <div class="col-md-6 type-calcio">
                                    ...
                                    <select data-plugin-selectTwo class="form-control populate" data-filter="calcio">
										...
										<? if($type_sport[$nameClass]=="CALCIO"):   //GIUSEPPE 2016-12-13?>
										...
										<option value="isTennis" selected data-filter="isTennis" data-title="isTennis" title="Tennis">Tennis</option>
					...
					<?
						...
						if ($block['Campi']['descrizione_campo'] == '' && $block['Upload'] == array())
						$block_link = "";
						...
						//GIUSEPPE 2016-12-13
						if ($block['Campi']['is5'] && $block['Campi']['is7'])
						$type_campo = 'Calcio a 5, calcio a 7';
						elseif ($block['Campi']['is5'] && !$block['Campi']['is7'])
						$type_campo = 'Calcio a 5';
						elseif ($block['Campi']['is7'] && !$block['Campi']['is5'])
						$type_campo = 'Calcio a 7';
						else
						$type_campo = '';
						if ($block['Campi']['isEsclusive'] == 1)
						$type_campo .= ' - IN ESCLUSIVA';
						
						if ($block['Campi']['is11'] == 1)
						$type_campo .= ', Calcio a 11';
						
						//GIUSEPPE 2016-12-13 ------------------
						if ($block['Campi']['isTennis'] == 1)
						{
							if($type_campo=="")
							{
								$type_campo = "Tennis";
					...
					?>
					<? if($type_sport[$nameClass]=="CALCIO" && $type_campo!="Tennis" || $type_sport[$nameClass]=="TENNIS"):   //GIUSEPPE 2016-12-13?>
					<div class="row campi" data-hour="<?= $block['Campi']['countHour']; ?>" class="block-box" data-is5="<?= ($block['Campi']['is5'] != 1) ? $block['Campi']['is5'] : 'is5'; ?>"  data-is11="<?= ($block['Campi']['is11'] != 1) ? $block['Campi']['is11'] : 'is11'; ?>"  data-is7="<?= ($block['Campi']['is7'] != 1) ? $block['Campi']['is7'] : 'is7'; ?>"  data-isTennis="<?= ($block['Campi']['isTennis'] != 1) ? $block['Campi']['isTennis'] : 'isTennis'; ?>"  data-citta="<?= $block['Campi']['Citta']; ?>">
						
						<div>
							
							
							<? //if($type_sport[$nameClass]=="CALCIO" && $type_campo!="Tennis"): ?>
            ...
            <div class="col-md-3" style="display: none;">
                ...
                <ul class="nav nav-list narrow">
					...
					<li><a href="javascript:;" data-filter="isTennis" data-title="isTennis" title="Tennis">Tennis</a></li>
				</ul>					
                <hr />	
                <? if (count($citta)): ?>
