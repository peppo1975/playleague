...
<div class="tab-squadra">
		<div class="list-tab text-center">
			<ul class="pagination pagination-sm">
				...
				<li class="active"><a href="/squadre/<?=$squadra['Squadre']['Squadra'];?>/1/<?=strtolower(Inflector::Slug($squadra['Squadre']['Denominazione'],'-'));?>" title="<?=$squadra['Squadre']['Denominazione'];?>">Squadra</a></li>
				<? endif; ?>
		...
		<div class="content-tab">
			<div class="box-sx-tab">
				<div class="team-image">
					...
					?>
					<img src="<?=$link;?>" class="img-thumbnail" alt="<?=($uploads['Squadra'][0]['title'])? $uploads['Squadra'][0]['title']:$uploads['Squadra'][0]['name'];?>" />															
					
					<? else: ?>
					
					<img src="/img/default-photo.png" alt="nome squadra" width="100%" class="img-thumbnail" />
