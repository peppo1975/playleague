...
<? else: ?>
                ...
                <form class="form-horizontal form-bordered" autocomplete="off" method="post" onsubmit="return false;">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <!--//GIUSEPPE 2023-07-08-->
                            <p class="lead" style="color: red; display: none" id="alert-transazione">Problemi con la transazione! Riprova più tardi</p>
                            <!--*********************-->
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        {
            //GIUSEPPE 2023_07_08 - - - - - - - - -
            var response_curl = '<?= $response_curl ?>';
            if (response_curl === 'Unauthorized')
            {
                var nextstep = document.querySelector("#nextstep");
                nextstep.classList.remove("btn-success");
                nextstep.classList.add("btn-secondary");
               document.querySelector("#alert-transazione").style.display = 'block'; 
            }
            //- - - - - - - - - - - - - - - - - - -
            ...
            $("#nextstep").click(function ()
            {
                ...
                if (response_curl === 'Unauthorized')
                {
                    alert("Problemi con la transazione! Riprova più tardi");
                    return;
                }
                //- - - - - - - - - - - - - - - - - - -
                ...
                if (validateMail)
                {
                    if ($(".cauzione:first").is(':checked'))
                    {
                        ...
                        {
                            //GIUSEPPE 2023_07_08 - - - - - - - - -
                            var json = JSON.parse(response_curl);
