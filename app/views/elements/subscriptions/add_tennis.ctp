    ...
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="esistente" style="display: none;">
                        <?= $this->Form->input('nomesquadra2', array('type' => 'select', 'empty' => 'Seleziona una squadra...', 'class' => 'form-control populate', 'data-plugin-selectTwo' => 1, 'label' => false, 'options' => $squadres_tennis, 'div' => false)); ?>					
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <?= $this->Form->input('campionato', array('empty' => 'Seleziona campionato...', 'options' => $campionati_tennis, 'type' => 'select', 'label' => false, 'div' => false, 'class' => 'form-control populate', 'data-plugin-selectTwo' => 1)); ?>	
                </div>											
            </div><!---->
        ...
        <div class="panel-body">
            <form class="form-horizontal form-bordered" autocomplete="off" method="post" onsubmit="return false;">
                ...
                <div class="form-group not-exists">
                    <label class="col-md-3 control-label" for="inputDefault">Impianto sportivo<sup>*</sup></label>
                    <div class="col-md-6">
                        <input name="data[Subscription][campo]" type="text" id="SubscriptionCampo" class="form-control">
                    </div>
                </div>
...
<!--<select name = "data[Subscription][ora]" id="SubscriptionOra" class="form-control" >
    ...
    <? $reponsabili = array('Responsabile 1 * - Obbligatorio', 'Responsabile 2 - Facoltativo', 'Responsabile 3 - Facoltativo'); ?>

    <? foreach ($reponsabili as $i => $responsabile): ?>

        <section class="panel responsabili" id="resp_<?= $i ?>">
            <?
            $button_remove = "";

            if ($i > 0)
            {
                //$button_remove = '<a class="btn btn-default right-element" onclick="hide_resp(\''.$i.'\')">X</a>';
                $button_remove = '<a class="panel-action panel-action-dismiss right-element" data-panel-dismiss="" onclick="hide_resp(\'' . $i . '\')" style=" margin: 10px 0 0 15px;"></a>';
            }
            ?>
            <header class="panel-heading">
                <h2 class="panel-title left-element"><?= $responsabile; ?>&#9;&#9;&#9;</h2><?= $button_remove ?><a class="btn btn-default right-element" onclick="reset_text_box('<?= $i ?>')">Svuota</a>
                <div class="clear"></div>
            </header>
            ...
            <div class="panel-body">
                ...
                <!--<div class="form-group not-exists">
                        <label class="col-md-3 control-label" for="inputDefault" class="form-control"><strong>id<sup>*</sup></strong></label>
                        <div class="col-md-6">
                                <input name="<?= 'Id_anagrafica_' . $i ?>" type="text" id="<?= 'Id_anagrafica_' . $i ?>" class="form-control">
                        </div>
                </div>-->
    ...
    <div class="panel-footer">
        <ul class="pager">
            ...
            <li class="previous" id="add_resp">
                <a  class="btn btn-default"><i ></i> Aggiungi responsabile </a>
            </li>
        </ul>
    </div>
</form>
