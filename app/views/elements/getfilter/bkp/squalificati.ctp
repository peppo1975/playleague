									...
									<table id="diffidati" class="table-matches <? if(($giornata['Match']['Giornata'] + 1) != $nextDay): ?>hidden<? endif; ?>" data-giornata-id="<?=$giornata['Match']['Giornata'];?>">
									...
									<tr>
									<td>
									Prossimo aggiornamento squalificati <b><?=date("d/m/Y",strtotime('next Saturday'));?></b>
									</td>
									</tr>
