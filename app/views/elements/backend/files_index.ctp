...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			$("#uploadTable tbody").sortable({
			
				items: ".index-file-row",
				...
				update: function() {
					...
					var order = $("#uploadTable tbody").sortable('toArray');
					
					$("#uploadTable tr.index-file-row").removeClass('alterna');
						
					$("#uploadTable tr:even").addClass('alterna');
														
					$.post('/admin/uploads/sortableOrder/', { Data: order });
																
				}
			
			});
			
			$("#uploadTable tbody").disableSelection();
...
<table id="uploadTable" class="form_table">
								...
								<? $files = Set::Sort($files, '{n}.Upload.order', 'ASC'); ?>
								
								<? foreach ($files as $file): ?>

								
								<tr id="<?=$file['Upload']['id'];?>" class="index-file-row <?=$alterna;?>">
								<td class="tools">
									<ul>
