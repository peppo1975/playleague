		...
		$(function() {
			...
			$(".formSearch input[type='button']").live('click', function(e, athlete) {
				...
				$('.div_append').html('');
					...
					$('#timmybox_container').css('margin-left',100);
