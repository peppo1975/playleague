...
<table align="center" cellspacing="0" class="newsletter">
    <thead>
        <tr class="logo">
            <!-- head logo -->
            <td align="left">
                <a href="http://www.midlandsport.it" title="http://www.midlandsport.it"> <img alt="logo" src="http://www.midlandsport.it/files/uploads/SF_NL_boll_uff_2016_2.jpg" /> </a></td>
        </tr>
        <!-- close head logo -->
    </thead>
    <tfoot align="center">
        <tr class="post-footer">
            ...
            <td>
                <p>
                    <a href="http://www.midlandsport.it"> Midland Global Sport SSDRL</a> | Via Pagnini, 13/R 50134 Firenze - T. 055 4630649 F. 055 0138719 <a href="mailto:info@midlandeuropa.com" title="mail to">info@midlandsport.it</a> P.I. <a href="http://www.midlandsport.it/contenuti/127/copyright">04733710489</a></p>
            </td>
        </tr>
    </tfoot>
    <tbody style="background-color: #f5f5f5;">
        <tr class="post-title">
            <!-- post -->
            <td align="center">
                <a href="&lt;?=$merge?&gt;" title="<?= $data['Newsletter']['title']; ?>"> </a>
                <h1>
                    <a href="<?= $merge ?>" title="<?= $data['Newsletter']['title']; ?>"><?= $data['Newsletter']['title']; ?></a></h1>
            </td>
        </tr>
        <tr class="post-allegato">
            <td align="left">
                <a href="http://www.midlandsport.it"> <?
                    ...
                    {
                        if ($tmp['isEvidenza'] == 1 && $tmp['group'] == 'image')
                        {
                            $evidenza = $tmp;
                            break;
                        }
