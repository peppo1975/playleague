...
<table align="center" cellspacing="0" class="newsletter">
	...
	<tfoot align="center">
		<tr class="post-footer">
			...
			<td>
				<p>
					578Toscana.it | <a href="mailto:info@midlandeuropa.com" title="mail to"><span style="color:#006400;">info@578toscana.it</span></a></p>
			</td>
		</tr>
	</tfoot>
		...
		<tr class="dislaimer-txt">
			<td>
				<div class="disclaimer-content">
					<span style="color:#006400;"><?=strip_tags($disclaimer,'<a>');?></span></div>
			</td>
		</tr>
	</tbody>
</table>
