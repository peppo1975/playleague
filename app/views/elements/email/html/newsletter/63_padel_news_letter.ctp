<table border="0" cellpadding="0" cellspacing="0" style="margin: 50px auto 0px; background-color: #ffffff; font-family: 'Raleway', sans-serif; line-height: 1.8em; color: #000000;" width="760px">
	<thead style="background-color: #f4f4f4;">
		<tr>
			<td align="left">
				<a href="https://www.mgstennis.it/contenuti/213/le-manifestazioni-di-padel"><img id="timmy_img" src="https://www.midlandsport.it/assets/images/thumbs/13ac8856f5d45c1b223052df6cb8c18d.jpg" style="width: 760px; height: 104px; display: inline;" /></a></td>
		</tr>
	</thead>
	<tfoot>
