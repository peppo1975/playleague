...
<table align="center" cellspacing="0" class="newsletter">
	<thead>
		<tr class="logo">
			<!-- head logo -->
			<td align="left">
				<a href="http://www.midlandsport.it" title="http://www.midlandsport.it"> <img alt="logo" src="http://www.midlandsport.it/img/website/header-newsletter.png" /> </a></td>
		</tr>
		<!-- close head logo -->
	</thead>
	<tfoot align="center">
		<tr class="post-footer">
			...
			<td>
				<p>
					yourgame.it &copy; 2014 all rights are reserved&nbsp;&nbsp; <a href="mailto:info@midlandeuropa.com" title="mail to">info@yourgame.it</a></p>
			</td>
		</tr>
	</tfoot>
