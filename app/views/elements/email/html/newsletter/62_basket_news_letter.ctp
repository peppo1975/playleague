<table border="0" cellpadding="0" cellspacing="0" style="margin: 50px auto 0px; background-color: #ffffff; font-family: 'Raleway', sans-serif; line-height: 1.8em; color: #000000;" width="760px">
	<thead style="background-color: #f4f4f4;">
		<tr>
			<td align="left">
				<a href="https://www.midlandsport.it/contenuti/196/le-manifestazioni-di-basket"><img id="timmy_img" src="https://www.midlandsport.it/assets/images/thumbs/ba95d0dff4fb99675e007a62aecf8b3d.jpg" style="width: 760px; height: 104px; display: inline;" /> </a></td>
		</tr>
	</thead>
	<tfoot>
