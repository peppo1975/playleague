...
<head>
	...
	<title>Newsletter <?=Configure::read('server_name');?> - <?=$data['Newsletter']['title'];?></title>
	<style type="text/css">
	...
	<table align="center" class="newsletter" cellspacing="0">
		<thead>
			<tr class="logo"><!-- head logo -->
				<td align="left">
					<a title="<?=Configure::read('server_name');?>" href="<?=Configure::read('server_name');?>">
						<img src="<?=Configure::read('server_name');?>/img/website/header-newsletter.png" alt="logo" />
					</a>
				</td>
			</tr><!-- close head logo -->
		</thead>
		<tbody style="background-color: #f5f5f5;">
			<tr class="post-title"><!-- post -->
				<td align="left">
					<a href="<?=Configure::read('server_name');?>" title="<?=$data['Newsletter']['title'];?>">
			...
			<tr class="post-allegato">
				<td align="left">
					<a title="<?=Configure::read('server_name');?> - <?=($evidenza['title'] != '')? $evidenza['title'] : 'allegato';?>" href="<?=Configure::read('server_name');?>">
		...
		<tfoot align="center">
			<tr class="post-footer"> <!-- footer -->
				<td>
					<p>
						<a href="<?=Configure::read('server_name');?>">Asd Midland Firenze</a> | Via Pagnini, 13/R 50134 Firenze - T. 055 4630649 F. 055 0138719 <a href="mailto:info@midlandeuropa.com" title="mail to">info@midlandeuropa.com</a> P.I. 05820810488 
					</p>
				</td>
			</tr>
		</tfoot>
