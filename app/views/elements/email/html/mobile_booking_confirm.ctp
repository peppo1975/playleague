...
<a href="http://<?=$_SERVER['SERVER_NAME'];?>/mobile/bookingCancel/<?=md5($book_id);?>" title="Cancella prenotazione">http://<?=$_SERVER['SERVER_NAME'];?>/mobile/bookingCancel/<?=md5($book_id);?></a>
