...
class ThumbnailHelper extends Helper    {
 	...
 	function frame_link($options = array())
	{
		...
		if (!empty($video)) {
			...
			if (!empty($video['Upload']['video_preview']) && is_file('/var/www/timmytag/midland2015cake2/app/webroot' . '/' . $video['Upload']['video_preview'])) {
    ...
    public function link($options = array()) {
		...
		if (!isset($options['save_path'])) $options['save_path'] = '/var/www/timmytag/midland2015cake2' . '/app/webroot/assets/images/thumbs';
