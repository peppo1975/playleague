	...
	<?=$this->Form->create('Causalresult', array('action' => 'search','prefix' => 'admin','class' => 'formAdd'));?>

	<div class="form_header">

								<h2>Ricerca tabella causali risultato</h2>
								<ul>
	...
	<?=$this->Form->input('PuntiDisciplina', array('type' => 'text'));?>
