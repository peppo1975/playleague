	...
	<?=$this->Form->create('Ranking', array('action' => 'filters','prefix' => 'admin','class' => 'formAdd'));?>

	<div class="form_header">

								<h2>Filtra classifiche</h2>
								<ul>
	...
	<?//=$backend->getFilter('Ranking.NomeSquadra');?>
	
	<div class="clear"></div>

	<?=$backend->getFilter('Ranking.NomeCampionato');?>
