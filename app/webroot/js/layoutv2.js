...
$(function() {
	...
	// 	if (imexecuting == 1) return;
	// 	imexecuting = 1;
	// 	if (champ_id == undefined) champ_id = $("*[name='campionati_id']").val()

	// 	ajaxLoader('show');
		
	// 	var squadra_id = null;
		
	// 	if ($("*[name='squadra_id']").val() != 0) squadra_id = $("*[name='squadra_id']").val();
	...
	// 		});
	// 		}else
	// 		$("#tabsNavigationSimpleIcons3 .table-container").html(data).css('opacity',0).slideDown(300,function() {
	...
	$("*[name='filter_select']").live('change',function() {
			...
			getFilter(val,$("*[name='girone_id']").val(),$("*[name='filter_select']").val(), undefined, undefined, "#tabsNavigationSimpleIcons3 .table-container");
	...
	$("*[name='girone_id']").change(function() {
		...
		$.get("/sections/getSquadreFromGirone/" + $(this).val(),function(data) {
			...
			getFilter($("*[name='campionato_id']").val(),$(me).val(),tab, undefined, undefined, "#tabsNavigationSimpleIcons3 .table-container");
	...
	$("*[name='squadra_id']").live('change',function() {
			...
			if ($("*[name='filter_team']").val() != 'false') {
				...
				if ($("#team-button").hasClass('selected')) {
						...
						getFilter($("*[name='campionato_id']").val(),$("*[name='girone_id']").val(),$("*[name='filter_select']").val(),1, undefined, "#tabsNavigationSimpleIcons3 .table-container");
